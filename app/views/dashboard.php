...
<div class="flex-1 p-4 h-full">
    <div class="flex gap-3 justify-center flex-wrap mb-10">
        ...
        <div class="flex bg-blue-200 p-3 flex-1 rounded-md">
            ...
            <div class="text-right"><?= $this->model->getTableRow("accommodations")?></div>
            </div>
        ...
        <div class="flex bg-blue-200 p-3 flex-1 rounded-md">
            ...
            <div class="text-right"><?= $this->model->getTableRow("activities")?></div>
            </div>
